...
namespace Services
{
    public class BasketService(IBasketRepository basketRepository, IMapper mapper) : IBasketService
    {
        ...
        public async Task<BasketDto> AddOrUpdateBasketAsync(BasketDto basketDto)
        {
            var basket = mapper.Map<CustomerBasket>(basketDto);
            basket = await basketRepository.AddOrUpdateAsync(basket);
        ...
        {
            var flag = await basketRepository.DeleteAsync(id);
